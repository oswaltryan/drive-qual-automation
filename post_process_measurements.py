...
def extract_from_null_field(null_field):
    """
...
def process_csv_to_json_and_print_meas1(file_path, measurement, index):
    """
...
def save_currents_to_json(max_current, rms_current, output_filename="currents.json"):
    """
